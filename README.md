...
Меня зовут Юля, я системный аналитик DWH из Иркутска (Россия).
- :rocket: Вот уже несколько лет я погружена в системный анализ в мире больших данных. 

- :seedling: Влюблена в исследование данных, построение грамотных процессов и написание документации.

- :pencil: Веду свой <a href="https://t.me/+Zr6Fe-IrOVY0YjUy">блог</a>, где рассказываю о разном: о системном анализе, Big Data, различных СУБД, ETL, SQL и прочем около DWHшном.
